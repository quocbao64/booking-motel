        ...
        <div className={style.header}>
            <div className={style.header_main}>
                {type !== "hList" && (
                    ...
                    <p>
                        Id harum blanditiis, libero odit eius adipisci atque, ducimus iste commodi provident ut esse accusamus excepturi aliquam culpa nostrum iure tenetur itaque?
                    </p>
