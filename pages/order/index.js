    ...
    return (
        <div>
            ...
            <div className={style.order_page}>
                <div style={{fontSize: "32px", fontWeight: 700}}>Danh sách đơn thuê phòng của bạn</div>
                <div>
                    ...
                    <div>
                            ...
                            <div style={{display: "flex", alignItems: "center", marginBottom: "5px"}}>
                                <FaRegCheckCircle style={{marginRight: "16px", fontSize: "20px", color: "#008009"}} />
                                Bạn chỉ có thể hủy thuê phòng bằng cách gọi cho chúng tôi theo số: 
