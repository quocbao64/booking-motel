        ...
        },
        {
            ...
            render: (value) => {
                return <div style={{margin: "5px"}}>
                    <a href='/invoice'><button className={style.reverse_button} onClick={(e) => handleReverseSubmit(e)}>Thuê phòng ngay</button></a>
                </div>
            },
        },
    ];
            ...
            <div className={style.hotel_detail_main}>
                ...
                <div className={style.hotel_detail_right}>
                    ...
                    <div className={style.hotel_detail_booking}>
                        ...
                        <p>
                            Phòng này được đánh giá rất tốt với <b>{5} sao</b>.
                        </p>
